...
public class DryingTableMenu extends SimpleAbstractContainerMenu {
    ...
    public DryingTableMenu(int containerID, Inventory inventory, BlockPos pos, ContainerData data) {
        super(UtilityMenuTypes.DRYING_TABLE_MENU.get(), containerID, inventory, pos, 2);
