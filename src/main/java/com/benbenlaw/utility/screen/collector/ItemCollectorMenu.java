...
public class ItemCollectorMenu extends SimpleAbstractContainerMenu {

    protected ItemCollectorBlockEntity blockEntity;
    protected Level level;
    protected ContainerData data;
    protected Player player;
    protected BlockPos blockPos;

    public ItemCollectorMenu(int containerID, Inventory inventory, FriendlyByteBuf extraData) {
    ...
    public ItemCollectorMenu(int containerID, Inventory inventory, BlockPos pos, ContainerData data) {
        ...
        this.data = data;
        this.blockPos = pos;
        this.blockEntity = (ItemCollectorBlockEntity) level.getBlockEntity(pos);
