...
public class GhostFilterCollector implements IGhostIngredientHandler<FluidCollectorScreen> {

    @Override
    public <I> List<Target<I>> getTargetsTyped(FluidCollectorScreen gui, ITypedIngredient<I> ingredient, boolean doStart) {
